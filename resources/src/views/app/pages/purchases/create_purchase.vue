...
export default {
  ...
  methods: {
    ...
    Modal_Updat_Detail(detail) {
      ...
      this.detail.batch_no = detail.batch_no || "";
      this.detail.expiry_date = detail.expiry_date || "";
    ...
    Update_Detail() {
      ...
      for (var i = 0; i < this.details.length; i++) {
        if (this.details[i].detail_id === this.detail.detail_id) {
          ...
          this.details[i].batch_no = this.detail.batch_no;
          this.details[i].expiry_date = this.detail.expiry_date;
