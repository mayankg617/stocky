       ...
       <div slot="table-actions" class="mt-2 mb-3">
        ...
        <template slot="table-row" slot-scope="props">
          ...
          <span v-else-if="props.column.field == 'name'">
            ...
            <span v-if="props.row.expired_batches_count && props.row.expired_batches_count > 0" class="badge badge-danger ml-2">
              {{ $t('Expired') }} ({{ props.row.expired_batches_count }})
            </span>
            <span v-else-if="props.row.expiring_batches_count && props.row.expiring_batches_count > 0" class="badge badge-warning ml-2">
              {{ $t('Expiring') }} ({{ props.row.expiring_batches_count }})
            </span>
          </span>
